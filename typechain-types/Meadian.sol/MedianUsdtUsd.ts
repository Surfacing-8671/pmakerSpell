...
export interface MedianUsdtUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianUsdtUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianUsdtUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianUsdtUsdInterface;
