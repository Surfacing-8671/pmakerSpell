...
export interface MedianRethUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianRethUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianRethUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianRethUsdInterface;
