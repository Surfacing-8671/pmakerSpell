...
export interface MedianMaticUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianMaticUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianMaticUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianMaticUsdInterface;
