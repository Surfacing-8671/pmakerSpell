...
export interface MedianBatUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianBatUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianBatUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianBatUsdInterface;
