...
export interface MedianLrcUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianLrcUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianLrcUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianLrcUsdInterface;
