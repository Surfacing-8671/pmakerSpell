...
export interface MedianYifiUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianYifiUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianYifiUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianYifiUsdInterface;
