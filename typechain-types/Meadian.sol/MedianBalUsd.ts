...
export interface MedianBalUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianBalUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianBalUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianBalUsdInterface;
