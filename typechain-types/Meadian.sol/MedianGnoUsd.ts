...
export interface MedianGnoUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianGnoUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianGnoUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianGnoUsdInterface;
