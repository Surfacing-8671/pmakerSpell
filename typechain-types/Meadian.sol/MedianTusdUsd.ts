...
export interface MedianTusdUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianTusdUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianTusdUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianTusdUsdInterface;
