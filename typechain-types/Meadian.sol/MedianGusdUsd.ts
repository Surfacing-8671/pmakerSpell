...
export interface MedianGusdUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianGusdUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianGusdUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianGusdUsdInterface;
