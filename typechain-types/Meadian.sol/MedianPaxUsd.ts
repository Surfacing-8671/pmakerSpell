...
export interface MedianPaxUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianPaxUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianPaxUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianPaxUsdInterface;
