...
export interface MedianAaveUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianAaveUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianAaveUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianAaveUsdInterface;
