...
export interface MedianCompUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianCompUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianCompUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianCompUsdInterface;
