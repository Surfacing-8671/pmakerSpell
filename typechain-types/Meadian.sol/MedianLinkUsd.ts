...
export interface MedianLinkUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianLinkUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianLinkUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianLinkUsdInterface;
