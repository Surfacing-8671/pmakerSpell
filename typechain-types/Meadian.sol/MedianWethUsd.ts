...
export interface MedianWethUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianWethUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianWethUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianWethUsdInterface;
