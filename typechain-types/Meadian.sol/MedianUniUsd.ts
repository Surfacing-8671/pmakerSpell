...
export interface MedianUniUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianUniUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianUniUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianUniUsdInterface;
