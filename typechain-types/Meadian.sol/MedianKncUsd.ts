...
export interface MedianKncUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianKncUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianKncUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianKncUsdInterface;
