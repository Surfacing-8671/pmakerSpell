...
export interface MedianManaUsdInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "age"
      | "bar"
...
export interface MedianManaUsd extends BaseContract {
  connect(runner?: ContractRunner | null): MedianManaUsd;
  waitForDeployment(): Promise<this>;

  interface: MedianManaUsdInterface;
