...
export interface OmegaPokerFeedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WPLS"
      | "WPLSEDAI"
...
export interface OmegaPokerFeed extends BaseContract {
  connect(runner?: ContractRunner | null): OmegaPokerFeed;
  waitForDeployment(): Promise<this>;

  interface: OmegaPokerFeedInterface;
