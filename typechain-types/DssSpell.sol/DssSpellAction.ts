...
export interface DssSpellActionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "actions"
      | "description"
...
export interface DssSpellAction extends BaseContract {
  connect(runner?: ContractRunner | null): DssSpellAction;
  waitForDeployment(): Promise<this>;

  interface: DssSpellActionInterface;
