...
export interface DssSpellInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "action"
      | "cast"
...
export interface DssSpell extends BaseContract {
  connect(runner?: ContractRunner | null): DssSpell;
  waitForDeployment(): Promise<this>;

  interface: DssSpellInterface;
